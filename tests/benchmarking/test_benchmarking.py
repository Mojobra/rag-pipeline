...
class BenchmarkCliTests(unittest.TestCase):
    ...
    def _run_benchmark(
        ...
        *,
        ...
        from rag_pipeline.benchmarking.artifacts import load_benchmark_artifact
        from rag_pipeline.benchmarking.provenance import fingerprint_corpus
        ...
        with patch(
            "rag_pipeline.benchmarking.runner.create_local_embedding_service",
            return_value=embedding_service,
        ) as embedding_factory:
            with patch(
                "rag_pipeline.benchmarking.runner."
                "create_local_sparse_embedding_service",
                return_value=sparse_service,
            ) as sparse_factory:
                with patch(
                    "rag_pipeline.benchmarking.runner.create_local_answer_generator",
